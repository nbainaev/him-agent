...
def resolve_data_generator(config: TConfig, **induction_registry):
    ...
    if generator_type == 'synthetic':
        from hima.experiments.temporal_pooling.depr.blocks.dataset_policies import SyntheticPoliciesGenerator
        ...
        from hima.experiments.temporal_pooling.depr.blocks.dataset_aai import AAIRotationsGenerator
